...
def main() -> None:
    ...
    if args.command == "run-demo":
        positions = _load_structured_list(args.positions_json) if args.positions_json is not None else _parse_symbol_list(args.positions)
        watchlist = _load_structured_list(args.watchlist_json) if args.watchlist_json is not None else _parse_symbol_list(args.watchlist)

...
class _FinalReportCore(BaseModel):
    """LLM-facing schema for report generation — intentionally excludes detected_scenario
    and equity_opportunities which are populated from pipeline state, not generated by the LLM."""
...
class ReportBuilder:
    ...
    def build(
        ...
        fallback_core = _FinalReportCore(
        ...
        core_result, llm_diag = self.reasoner.refine_model(
            ...
            fallback=fallback_core,
        )
        # Promote _FinalReportCore → FinalReport, enforce pipeline-level overrides
        final_report = FinalReport(
            **core_result.model_dump(),

...
Code: `src/faultline/models/contracts.py::StageTransitionWarning`
...
Code: `src/faultline/models/contracts.py::MarketImplication`
...
- `exit`
- `avoid`
Code: `src/faultline/models/contracts.py::ActionRecommendation`

### Endangered Symbol
Held symbol flagged as vulnerable under current calibrated downside implications.  
Code path: `src/faultline/analysis/system_first.py::ActionEngine`
...
Code: `src/faultline/models/contracts.py::OperatorPolicyConfig`
...
Code path: `src/faultline/analysis/system_first.py::ActionEngine._timing_actions`

## Learning Loop

### Outcome Record
Follow-up evaluation record for a prediction, including status (`confirmed`, `partial`, `unconfirmed`) and confidence delta.  
Code: `src/faultline/models/contracts.py::OutcomeRecord`

### Calibration Signal
Aggregated historical prediction performance by prediction type; used to nudge confidence and rationale framing.  
Code: `src/faultline/models/contracts.py::CalibrationSignal`; loaded via `src/faultline/persistence/store.py`
...
Code: `src/faultline/graph/runner.py::auto_score_followups`; CLI `auto-followup`
...
Code: `src/faultline/models/contracts.py::FinalReport`

### Action Traceability
Section linking each action to supporting prediction(s), stage warnings, and evidence references.  
Code path: `src/faultline/synthesis/report_builder.py`

...
from strategic_swarm_agent.providers.live import AlphaVantageProvider, FredProvider, GDELTProvider, NewsAPIProvider, WebSearchEnricher
        ...
        "output": [
            {
                "type": "message",
                "content": [
                    {"type": "output_text", "text": "Some synthesis text.", "annotations": []}
                ],
            }
        ]
    }

...
def test_bad_calibration_makes_actions_more_conservative() -> None:
    ...
    good_actions, good_exits = action_engine.generate(snapshot, [implication], [], good_calibration)
    bad_actions, bad_exits = action_engine.generate(snapshot, [implication], [], bad_calibration)
